...
def parse_args(args):
    ...
    parser.add_argument('--platforms', nargs='*', default=None, help='Specify frameworks to run the benchmarks on(demilited by space). If None provided, benchmarks will be run on all supported frameworks.')
    ...
    parser.add_argument('--sg', default=1, choices=[0, 1], help='Use the skip-gram model; default is 1 (use 0 for continuous bag of words model)')
